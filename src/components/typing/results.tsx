...
import { Flame, Target, TrendingUp, Gauge, Lightbulb, Award } from "lucide-react";
      ...
      <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
        ...
        <div className="flex flex-row justify-between gap-6 lg:flex-col lg:justify-start">
          <div>
            ...
            <div className="text-hue font-mono text-6xl font-bold tabular-nums lg:text-7xl">
              {result.wpm}
            </div>
          </div>
          <div>
            <div className="text-dim font-mono text-xs tracking-widest uppercase">acc</div>
            <div className="font-mono text-4xl font-semibold tabular-nums lg:text-5xl">
              {result.accuracy}%
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-x-6 gap-y-2 font-mono text-sm sm:grid-cols-4">
        ...
        <div className="mt-10">
          ...
          <ul className="space-y-2.5">
            {insights.map((ins, i) => (
              <li
                key={i}
                className="bg-surface flex items-start gap-3 rounded-lg border px-4 py-3 font-mono text-sm leading-relaxed"
